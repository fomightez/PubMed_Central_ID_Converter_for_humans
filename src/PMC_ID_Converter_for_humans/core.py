...
# A simple library for using the PubMed Central ID Convert API for 
...
#
# To use via Python:
# from src.PMC_ID_Converter_for_humans import PMC_id_convert # because use `subprocess.run(['uv', 'pip', 'install', '-e', '.']` (equivalent of `uv pip install -e .`) for pytest conftest.py, with pytest use `from PMC_ID_Converter_for_humans import PMC_id_convert`
# PMC_id_convert('PMC3531190', email = '<your_email_here>')
# 
#
#
